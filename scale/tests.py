...
class FakeSerial:
    def __init__(self, initial_buffer=b'', responses=None, read_failures=0):
        self.timeout = 1
        self.is_open = True
...
class ReadWeightFromSerialTests(SimpleTestCase):
    ...
    def test_tries_cas_command_mode_prompt(self):
        ser = FakeSerial(responses={b"D00KW\r\n": b"00039.5\r\n"})

        result = read_weight_from_serial(ser)

        self.assertEqual(result, b"00039.5\r\n")
        self.assertIn(b"D00KW\r\n", ser.writes)
