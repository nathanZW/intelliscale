...
urlpatterns = [
    ...
    path('delivery-notes/<int:pk>/print-dispatch/', views.print_dispatch_note, name='print_dispatch_note'),
    path('delivery-notes/print-dispatch/', views.print_dispatch_note, name='print_dispatch_note_bulk'),
    ...
    path('scales/<int:scale_id>/stream/', views.stream_weight, name='stream_weight'),
